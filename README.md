...
**[StayPlanner](https://github.com/Surakattula-Rohith/StayPlanner)** — Hotel booking platform with 10 microservices. Spring Cloud Gateway, Eureka, Razorpay payments, the whole setup.

### Background

NIT Bhopal · Previously at CGI 
